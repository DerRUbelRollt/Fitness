...
function SettingsPage() {
  const { userName, setUserName, customActivities, addCustomActivity, deleteCustomActivity } =
    useStore();
    ...
    <div className="px-5 lg:px-10 py-6 lg:py-10 max-w-4xl mx-auto space-y-8">
      ...
      <section className="rounded-3xl border border-border/60 bg-card/60 p-5 lg:p-6 shadow-soft">
        ...
        <p className="text-sm text-muted-foreground mb-5">
          Erstelle eigene Sportarten mit Icon und Farbe
        </p>
              ...
              {ICON_OPTIONS.map((opt) => {
                ...
                return (
                  <button
                    ...
                    className={`h-8 w-8 grid place-items-center rounded-lg ${iconId === opt.id ? "bg-primary/20 ring-1 ring-primary" : "bg-accent/40"}`}
                  >
            ...
            {customActivities.map((c) => {
              ...
              return (
                ...
                >
                  ...
                  <button
                    onClick={() => deleteCustomActivity(c.id)}
