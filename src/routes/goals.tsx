    ...
    <div className="px-5 lg:px-10 py-6 lg:py-10 max-w-7xl mx-auto space-y-8">
      <PageHeader
        ...
        actions={
          ...
          >
            <Plus className="h-4 w-4 mr-1" /> Neues Ziel
          </Button>
        }
      />
          ...
          >
            ...
            <div className="space-y-4">
              <div>
                ...
                <Input
                  placeholder="z.B. 4× Gym pro Woche"
                  value={title}
                ...
                <div className="mt-1 grid grid-cols-3 gap-2">
                  {(["day", "week", "month"] as const).map((p) => (
                    <button
                      key={p}
                      onClick={() => setPeriod(p)}
                      className={`rounded-lg border px-3 py-2 text-sm font-medium ${period === p ? "border-primary bg-primary/10 text-primary" : "border-border/60"}`}
                    >
